...
This is the implementation plan for AI coding agents. The foundation is implemented: Java 25, Spring Boot 4.1.1 with MVC, Maven Wrapper 3.9.11, local PostgreSQL 15.19 through Compose, Flyway V1, Spring Data JDBC `Contestant` and `Pick` records, and public contestant/latest-week/weekly-picks APIs. The React/TypeScript frontend uses Vite, React Router, a responsive slide-out navigation drawer, a global home page, and Madison SC latest-week and weekly standings views. Administrator submission and further features remain planned. It defines shared technologies, architecture, and authentication for the personal website. Project-specific business requirements and data models live in `.projects/<project>/README.md`. Proposed API contracts and unresolved business rules are labeled explicitly.
